export function Logo(props: React.ComponentPropsWithoutRef<'svg'>) {
  const primaryTextColor = props.style?.color || '#0F172A'
  ...
  return (
    ...
    <svg
      ...
      style={{ ...props.style, color: primaryTextColor }}
    >
      <title>BlogPal</title>
      ...
      <g transform="translate(44,0)">
        ...
        >
          <tspan className="dark:text-white">Blog</tspan>
          <tspan fill={accentColor} dx="0">
            Pal
          </tspan>
        </text>
      </g>
