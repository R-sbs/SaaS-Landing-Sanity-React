...
const features = [
  {
    ...
    description: 'Create a brief in Sanity: headline, audience, tone.',
    image: screenshotPayroll,
  },
  {
    title: 'AI Draft',
    description: 'Generate a draft with GPT inside Studio — edit as needed.',
    image: screenshotExpenses,
  },
  {
    title: 'Auto-generate SEO',
    description:
      'Auto-generate SEO & socials — meta, alt-text, and 3 caption options.',
    image: screenshotVatReturns,
  },
  {
    title: 'Publish or schedule',
    description:
      'Publish or schedule — site rebuild triggers automatically and content goes live.',
      ...
      <Container className="relative">
        <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
          <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl md:text-5xl">
            Faster publishing, better SEO, less work.
          </h2>
          <p className="mt-6 text-lg tracking-tight text-blue-100">
            AI-assisted content pipelines (drafts, SEO, captions, alt-text) that
            live inside Sanity.
          </p>
        </div>
        <TabGroup
